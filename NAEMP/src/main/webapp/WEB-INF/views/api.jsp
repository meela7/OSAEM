...
<script type="text/javascript">
	$(function() {
		...
		if (url && url.length > 1) {
			...
			url = "http://117.16.146.59:8080/naemp/v2/api-docs.json";
		}
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<table class="table table-condensed table-striped">
					...
					<tbody>
						<tr>
							<td> <strong>Basic resources.</strong> A basic resource is a single instance
								of data entity (e.g., an individual fish species). Basic
								resources are logically analogous to a database record in
								relational database systems.</td>
						</tr>
						<tr>
							<td> <strong>Collection resources.</strong> A collection resource is defined
								to be the set of all the basic resources of the same type.
								Therefore, all the basic resources are grouped into collection
								resources. Collection resources are logically
